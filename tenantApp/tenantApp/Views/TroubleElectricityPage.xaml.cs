...
namespace tenantApp
{
	...
	public partial class TroubleElectricityPage : ContentPage
	{
        ...
        {
            getResponseFromSelected(Constants.BotAnswer_5);
        }

        private void trouble3_Clicked(object sender, EventArgs e)
        {
            getResponseFromSelected(Constants.BotAnswer_6);
        }
